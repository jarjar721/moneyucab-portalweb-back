...
BEGIN
	...
	IF (new.monto > monto_acum AND tipo_cuenta = 'Monedero' AND NOT EXISTS (SELECT * FROM OperacionesMonedero A WHERE A.idTipoOperacion = 2 AND A.referencia = new.referencia)) THEN
