...
{
	public class Comando_Reintegro_Tarjeta
	{
		...
		public Comando_Reintegro_Tarjeta(int IdUsuarioReceptor, int IdMedioPaga,double Monto, int IdOperacion)
		{
		...
		async public Task<Boolean> Ejecutar()
		{
			...
			dao.Pago_Tarjeta(_idUsuarioReceptor, _idMedioPaga, _monto, _idOperacion);
			return true;
		}
	}
}
