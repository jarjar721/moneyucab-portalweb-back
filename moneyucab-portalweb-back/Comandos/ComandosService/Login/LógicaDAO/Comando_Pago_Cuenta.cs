...
{
	public class Comando_Pago_Cuenta
	{
		...
		public Comando_Pago_Cuenta(int IdUsuarioReceptor, int IdMedioPaga, double Monto, int IdOperacion)
		{
		...
		async public Task<Boolean> Ejecutar()
		{
			...
			dao.Pago_Cuenta(_idUsuarioReceptor, _idMedioPaga, _monto, _idOperacion);
			return true;
		}
	}
}
